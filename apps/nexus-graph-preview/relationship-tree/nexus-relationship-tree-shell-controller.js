class NexusRelationshipTreeShellController {
  ...
  installMobileViewportFix() {
    ...
    style.textContent = `
      html.nexus-mobile-viewport-fixed,
      html.nexus-mobile-viewport-fixed body {
        width: 100% !important;
      ...
      html.nexus-mobile-viewport-fixed #root {
        position: fixed !important;
        left: 0 !important;
        right: 0 !important;
        top: var(--nexus-top-rail-h, 76px) !important;
        bottom: 0 !important;
      ...
      html.nexus-mobile-viewport-fixed #root > div:first-child,
      html.nexus-mobile-viewport-fixed #root > main:first-child {
        min-height: 100% !important;
      }

      html.nexus-mobile-viewport-fixed .nexus-top-rail,
      html.nexus-mobile-viewport-fixed .nexus-shell-panel,
      html.nexus-mobile-viewport-fixed [data-control][class*="bottom-"],
      html.nexus-mobile-viewport-fixed [class*="bottom-"] {
    ...
    const syncViewportHeight = () => {
      document.documentElement.style.setProperty('--nexus-visual-vh', `${window.innerHeight}px`);
    };
    syncViewportHeight();
